...
# Identifies the shape of every machine-readable document the CLI emits, so
# consumers can detect breaking changes without sniffing for fields.
...
class MarkdownReporter:
    ...
    def write(self, report: ScanReport) -> None:
        ...
        self._print("---")
        self._print(
            "*Generated by [euaiact-lint](https://github.com/ai-safe-earth/AI-Safety-Guardrails) — EU AI Act Static Code Analyzer*"
        )
